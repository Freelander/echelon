...
$table = "penalties, clients as target";

//custom where operation
$custom_where = "penalties.type = 'Kick' AND inactive = 0 AND penalties.client_id = target.id AND penalties.admin_id = 0";
...
foreach($main_query['data'] as $data) {
	...
	$response['aaData'][] = array( $client_link, $time_add_read, $reason_read );
}
