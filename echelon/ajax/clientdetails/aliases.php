 ...
 * extra client info block when clicked on "Aliases" tab.
 */
...
<table>
	...
	<?php
	if(!$db->error) {
		$query = "SELECT alias, num_used, time_add, time_edit FROM aliases WHERE client_id = $cid ORDER BY time_edit DESC";
